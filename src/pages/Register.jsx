...
function Register(props) {
  ...
  return (
    <div className="w-full overflow-y-auto sm:overflow-y-none sm:grow flex flex-col sm:justify-center sm:items-center">
			<div className="w-full sm:w-11/12 md:w-10/12 lg:w-9/12 h-full sm:border-x px-6 py-10 flex flex-col gap-4 sm:justify-start items-center">
				<h1 className="font-bold text-4xl">Register</h1>
				<span className="font-thin text-md text-gray-600 w-96">You will create a OboSoft account, which will be used by all OboSoft services.</span>
				<div className="flex flex-col w-full sm:w-1/2 text-xl gap-5">
					<div className="flex flex-col">
						<label htmlFor="username" className="px-2">Username</label>
						<input 
							className="bg-white border-b border-gray-300 focus:outline-none focus:border-orange-400 font-thin text-lg px-2 py-1"
					...
					<div className="flex flex-col justify-between">
						<button 
							className='text-black flex flex-row justify-between items-center hover:border-b border-stone-700 hover:text-orange-500 text-2xl font-light py-2'
							onClick={() => {
						...
						<div className='flex flex-col justify-center mt-2 gap-1'>
								<a href='/login' className='text-black font-normal flex flex-row justify-between items-center hover:border-b border-stone-700 hover:text-orange-500 py-1 text-sm'> 
